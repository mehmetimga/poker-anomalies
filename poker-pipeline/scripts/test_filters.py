...
def test_poker_ukf():
    ...
    events = [
        {'timestamp': 1000.0, 'player_id': 'P1', 'action': 'bet', 'amount': 10.0, 'table_id': 1},
        {'timestamp': 1001.0, 'player_id': 'P1', 'action': 'raise', 'amount': 20.0, 'table_id': 1},
        {'timestamp': 1002.0, 'player_id': 'P1', 'action': 'bet', 'amount': 15.0, 'table_id': 1},
        {'timestamp': 1003.0, 'player_id': 'P1', 'action': 'bet', 'amount': 25.0, 'table_id': 1},
        {'timestamp': 1004.0, 'player_id': 'P1', 'action': 'fold', 'amount': 0.0, 'table_id': 1},
        {'timestamp': 1005.0, 'player_id': 'P1', 'action': 'bet', 'amount': 30.0, 'table_id': 1},
    ]
    ...
    for event in events:
        ...
        print(f"{status} Action: {event['action']:6s} ${event['amount']:6.2f} | "
    ...
    print(f"  State: position={stats['state'][0]:.2f}, velocity={stats['state'][1]:.2f}")
...
def test_anomaly_detection():
    ...
    normal_events = [
        {'timestamp': 1000.0, 'player_id': 'P1', 'action': 'bet', 'amount': 10.0, 'table_id': 1},
        {'timestamp': 1001.0, 'player_id': 'P2', 'action': 'bet', 'amount': 12.0, 'table_id': 1},
        {'timestamp': 1002.0, 'player_id': 'P1', 'action': 'bet', 'amount': 11.0, 'table_id': 1},
        {'timestamp': 1003.0, 'player_id': 'P2', 'action': 'bet', 'amount': 13.0, 'table_id': 1},
    ]
    ...
    collusion_events = [
        {'timestamp': 1010.0, 'player_id': 'P1', 'action': 'bet', 'amount': 100.0, 'table_id': 1},
        {'timestamp': 1010.5, 'player_id': 'P2', 'action': 'bet', 'amount': 95.0, 'table_id': 1},
    ]
